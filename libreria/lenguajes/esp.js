...
exports.Badmin = () => {
  return `*[ ! ] _El bot deve ser ascendido a admin!_*`
}
exports.Bloqueads = () => {
...
exports.wlcon = () => {
  return `*Bienbenida activado en este grupo [✓]* `
}
exports.wlcoff = () => {
  return `*Se desactivo la bienbenida [ ! ]* `
}
exports.wlcon2 = () => {
  return `_*[BIENBENIDA AUTOMÁTICA]*_ `
}
exports.dlinkon = () => {
...
exports.reg6 = () => {
  return `*Tas muy viejo para usar este bot u.u*`
}
exports.reg7 = () => {
